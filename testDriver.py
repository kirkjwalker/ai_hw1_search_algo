...
class TestDriver(unittest.TestCase):
    ...
    def test_CalcBoardSolution_for_DFS_case_1(self):
        ...
        print "\n"
        self.assertTrue(eight_puzzle_result.path_to_solution[0:3] == ['Up', 'Left', 'Down'], "Error: " + str(eight_puzzle_result.path_to_solution))
        self.assertTrue(eight_puzzle_result.path_to_solution[46138:46142] == ['Up', 'Left', 'Up', 'Left'], "Error: " + str(eight_puzzle_result.path_to_solution))
    ...
    def test_CalcBoardSolution_for_DFS_case_2(self):
        ...
        calc_board_solution = CalcBoardSolution()
        eight_puzzle_result = calc_board_solution.with_the_search_algorithm("dfs").and_the_board(tile_positions)
        self.assertTrue(eight_puzzle_result.path_to_solution[0:3] == ['Up', 'Up', 'Left'], "Error: " + str(eight_puzzle_result.path_to_solution[0:3]))
        self.assertTrue(eight_puzzle_result.path_to_solution[9609:9612] == ['Up', 'Up', 'Left'], "Error: " + str(eight_puzzle_result.path_to_solution[9609:9612]))
        ...
        print "\n"
#  
    def test_CalcBoardSolution_for_AST_case_1(self):
        tile_positions = [8,6,4,2,1,3,5,7,0]
        calc_board_solution = CalcBoardSolution()
        eight_puzzle_result = calc_board_solution.with_the_search_algorithm("ast").and_the_board(tile_positions)
        self.assertTrue(eight_puzzle_result.path_to_solution == ['Left', 'Up', 'Up', 'Left', 'Down', 'Right', 'Down', 'Left', 'Up', 'Right', 'Right', 'Up', 'Left', 'Left', 'Down', 'Right', 'Right', 'Up', 'Left', 'Down', 'Down', 'Right', 'Up', 'Left', 'Up', 'Left'], "Error: " + str(eight_puzzle_result.path_to_solution))
        self.assertTrue(eight_puzzle_result.cost_of_path == 26, "Error: " + str(eight_puzzle_result.cost_of_path))
#         self.assertTrue(eight_puzzle_result.nodes_expanded == 1585, "Error: " + str(eight_puzzle_result.nodes_expanded))
        self.assertTrue(eight_puzzle_result.search_depth == 26, "Error: " + str(eight_puzzle_result.search_depth))
        self.assertTrue(eight_puzzle_result.max_search_depth == 26, "Error: " + str(eight_puzzle_result.max_search_depth))
        print "\n"

    def test_CalcBoardSolution_for_AST_case_2(self):
        tile_positions = [6,1,8,4,0,2,7,3,5]
        calc_board_solution = CalcBoardSolution()
        eight_puzzle_result = calc_board_solution.with_the_search_algorithm("ast").and_the_board(tile_positions)
        self.assertTrue(eight_puzzle_result.path_to_solution == ['Down', 'Right', 'Up', 'Up', 'Left', 'Down', 'Right', 'Down', 'Left', 'Up', 'Left', 'Up', 'Right', 'Right', 'Down', 'Down', 'Left', 'Left', 'Up', 'Up'], "Error: " + str(eight_puzzle_result.path_to_solution))
        self.assertTrue(eight_puzzle_result.cost_of_path == 20, "Error: " + str(eight_puzzle_result.cost_of_path))
#         self.assertTrue(eight_puzzle_result.nodes_expanded == 696, "Error: " + str(eight_puzzle_result.nodes_expanded))
        self.assertTrue(eight_puzzle_result.search_depth == 20, "Error: " + str(eight_puzzle_result.search_depth))
        self.assertTrue(eight_puzzle_result.max_search_depth == 20, "Error: " + str(eight_puzzle_result.max_search_depth))
        print "\n"